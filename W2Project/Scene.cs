        ...
        public void MoveScene(SceneType type, int opt = 0)
        {
            ...
            switch (type)
            {
                ...
                case SceneType.Jobs:
                    ...
                    Console.SetCursorPosition(2, 12); Console.WriteLine("1. 전사 -> 체력 +100, 방어력 +3");
                    Console.SetCursorPosition(2, 13); Console.WriteLine("2. 궁수 -> 공격력 +5, 체력 -40, 방어력 -3");
                    Console.SetCursorPosition(2, 14); Console.WriteLine("3. 도적 -> 공격력 +3, 체력 -20, 방어력 -2");
