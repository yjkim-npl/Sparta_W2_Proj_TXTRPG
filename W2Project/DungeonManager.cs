...
namespace W2Project
{
    internal class DungeonManager
    {
        ...
        public void DungeonPhase()
        {
            ...
            Console.SetCursorPosition(5, 13); Console.WriteLine("1. 초급 던전");
            Console.SetCursorPosition(5, 14); Console.WriteLine("2. 중급 던전");
            Console.SetCursorPosition(5, 15); Console.WriteLine("3. 상급 던전");
